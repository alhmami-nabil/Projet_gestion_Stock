...
$username="root";
$password=""; 
$bdd = new PDO('mysql:host=localhost;dbname=projet_fil_rouge',$username,$password,array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
}catch (Exception $e)
...
':cin' => $cin));
$to="nabil.alhmami.solicode@gmail.com";
